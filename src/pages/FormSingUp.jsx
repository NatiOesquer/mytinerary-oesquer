...
export default function FormSignUp() {
    ...
    let countries = ["Argentina","United States","Canada","France","Germany","Brazil","England","Mexico"]
            ...
            try {
                ...
                Swal.fire({
                  ...
                  text: 'Something went wrong!',
                        ...
                        return (
                            <>
                                <div className="flex grow flex-col h-[120vh] bg-cover bg-center justify-around items-center sm:flex-row" style={{ backgroundImage: `url(../img/backgroundSign.jpg)` }}>
