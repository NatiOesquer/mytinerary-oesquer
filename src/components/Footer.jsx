...
export default function Footer() {
  ...
  return (
    <footer className="w-full h-[50px] bg-slate-300 flex items-center justify-center gap-5 flex-wrap">
        ...
        <a href="https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dg%26rlz%3D1C1CHZO_esAR1003AR1003%26oq%3Dg%26aqs%3Dchrome..69i57j0i271l3j69i60l4.839j0j1%26sourceid%3Dchrome%26ie%3DUTF-8&ec=GAZAAQ&hl=es&ifkv=AYZoVhc12hNAkAIybaL2MEeUXWevrMUlT_xFSZ2N1bIIuZr8rTpcql8QYbSY6hh0MeCAjYdnmIAcWg&passive=true&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S-871995924%3A1694483269938132&theme=glif" target="_blank" role="button">
            ...
            <a href="https://twitter.com/iniciarsesion?lang=es" target="_blank" role="button">
            ...
            <a href="https://www.youtube.com/" target="_blank" role="button">
