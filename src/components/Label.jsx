...
export default function Label({ options }) {
  return (
    ...
    className="flex items-center font-extrabold gap-2 bg-white font-medium px-3 py-2 w-[100px] text-slate-700 rounded-lg hover:bg-blue-300 hover:text-slate-900" 
